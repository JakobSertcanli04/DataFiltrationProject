...
def geminiClassify(input_csv_path, topics, citationCountLimit=10):
    ...
    # Convert citationCountLimit to integer
    try:
    ...
    for i, article in enumerate(articles):
        try:
            # More robust citation count handling
            citation_count = 0
            ...
            if citation_count_raw is not None:
                ...
                if citation_count_str.isdigit():
                    ...
                    # Try to extract digits from mixed string
                    import re
            ...
            if citation_count >= citationCountLimit:
                ...
                # Create a more explicit prompt for better topic matching
...
Return only the category name:"""
                ...
                # Validate the classification against the exact topics list
