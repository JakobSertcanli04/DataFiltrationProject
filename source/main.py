...
class ArticleClassifierApp:
    ...
    def run_gemini_classification(self, filepath, topics, citation_threshold):
        ...
        try:
            # Enhanced topic processing with better validation
            if not topics or not topics.strip():
                self.log("Error: No topics provided.")
                return
                
            # Split by comma and strip whitespace from each topic
            ...
            # Log the processed topics for verification
            ...
            # Run classification with improved Gemini function
    ...
    def generate_graph_from_csv(self, filepath):
        ...
        try:
            ...
            if 'Date' in df.columns:
                ...
                # Fill NaN years with a default value
                df['Year'] = df['Year'].fillna(2020)
            else:
                # If no date column, create sequential years
    ...
    def create_ui(self):
        ...
        # Instructions without welcome message
    ...
    def browse_csv_file(self):
        ...
        if filename:
            # Clear the entry first, then insert the new filename
